...
{*			{translate key="plugins.generic.inlineHtmlGalley.backToTop"}*}
			<img style="width: 50px;vertical-align: middle;border: 1px solid #dcb86d;border-radius: 50%;justify-self: end;" class="issue_button_statistic" src="http://localhost/rrsoc/plugins/themes/default/styles/images/up.png">
		</a>
	</div>
