		...
		if ($hookName == "ArticleHandler::view") {
			...
			foreach ($galleys as $galley) {
				if ($galley->getFileType() == 'text/html') {
                    ...
                    //$inlineHtmlGalley = mb_convert_encoding($inlineHtmlGalley, 'HTML-ENTITIES', 'UTF-8');
                    //$inlineHtmlGalley = mb_convert_encoding($inlineHtmlGalley, "utf-8", "windows-1251");
                    //$inlineHtmlGalley = iconv("windows-1251", "utf-8", $inlineHtmlGalley);
