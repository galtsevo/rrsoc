<?php return array (
  ...
  'common.fulltext' => 'Полный текст статьи',
  ...
  'search.fulltext' => 'Полный текст статьи',
...
',
  ...
  'validator.timezone' => 'Некорректная временная зона.',
