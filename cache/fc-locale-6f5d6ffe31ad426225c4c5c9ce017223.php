<?php return array (
  ...
  'submission.submit.genre.error' => 'Пожалуйста, выберите тип файла для каждого из загружаемых файлов.',
  ...
  'submission.event.fileRevised' => 'Версия «{$name}» (ID файла {$submissionFileId}) была загружена.',
  ...
  'submission.event.fileEdited' => 'Метаданные для файла «{$originalFileName}» были отредактированы пользователем {$username}.',
