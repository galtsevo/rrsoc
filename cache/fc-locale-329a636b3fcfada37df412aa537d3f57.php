<?php return array (
  ...
  'article.fulltext' => 'Полный текст статьи',
  ...
  'issue.fulltext' => 'Полный текст статьи',
...
<li>Используйте <strong>*</strong> в качестве специального символа, заменяющего любую последовательность символов, например, <em>соц* мораль</em> найдет документы, содержащие «социальная» или «социологическая»</li>
  ...
  'payment.type.publication.required' => 'Необходимо внести плату за публикацию.',
  ...
  'payment.requestPublicationFee' => 'Запросить плату за публикацию ({$feeAmount})',
